...
exec(open('/home/jetson/biped_ws/create_robot.py').read().replace("bpy.ops.render.render(write_still=True)", "pass"))
...
bpy.ops.wm.usd_export(
    filepath='/home/jetson/biped_ws/src/humanoid_description/usd/humanoid.usd',
